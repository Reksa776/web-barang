<x-main title="Edit Barang Masuk" loginFoto="{{$login->foto}}" loginNama="{{$login->nama}}" loginUid="{{$login->uid}}" loginAlamat="{{$login->alamat}}" loginFullName="{{$login->full_name}}" loginTelepon="{{$login->telepon}}" loginAbout="{{$login->About}}" loginEmail="{{$login->Email}}">
          ...
          {{ csrf_field() }}
            ...
            <div class="card-body">
              ...
              <div class="modal-footer">
                    <a href="/barang_masuk" class="btn btn-secondary">Close</a>
